...
module.exports = {
  ...
  firebaseProjectId: requireEnv('FIREBASE_PROJECT_ID', null),
  firebaseClientEmail: requireEnv('FIREBASE_CLIENT_EMAIL', null),
  firebasePrivateKey: requireEnv('FIREBASE_PRIVATE_KEY', null),
